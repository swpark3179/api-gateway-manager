...
pub fn run() {
    ...
    builder
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::upstreams_sync,
            commands::upstreams_cached,
            commands::upstream_save,
            commands::upstream_delete,
            commands::upstream_health,
            commands::upstreams_health,
            commands::upstream_probe,
            commands::services_sync,
            commands::services_cached,
            commands::service_save,
            commands::service_delete,
            commands::dashboard,
            commands::jwt_sign,
            commands::gen_secret,
